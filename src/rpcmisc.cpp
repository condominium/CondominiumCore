...
Value getinfo(const Array& params, bool fHelp)
{
    ...
    zcondominiumObj.emplace_back(Pair("total", ValueFromAmount(chainActive.Tip()->GetZerocoinSupply())));
    obj.emplace_back(Pair("zCDMsupply", zcondominiumObj));
