...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Condominium Core"),
     ...
     * override -datadir in the condominium.conf file in the default data directory
     * (to be consistent with condominiumd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
