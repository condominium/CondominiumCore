...
/** Utility functions used by the Condominium Qt UI.
 */
namespace GUIUtil
{
...
// Render Condominium addresses in monospace font
...
// Parse "condominium:" URI into recipient object, return true on successful parsing
