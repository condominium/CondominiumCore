...
{
    // return if URI is not valid or is no Condominium: URI
...
{
    // Convert condominium:// to condominium:
    //
    //    Cannot handle this later, because condominium:// will cause Qt to see the part after // as host,
...
void openConfigfile()
{
    ...
    /* Open condominium.conf with the associated application */
...
LSSharedFileListItemRef findStartupItemInList(LSSharedFileListRef list, CFURLRef findUrl)
{
    // loop through the list of startup items and try to find the condominium app
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    if (fAutoStart && !foundItem) {
        // add condominium app to startup item list
