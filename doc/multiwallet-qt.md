...
In order to support loading of multiple wallets in condominium-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is condominium.cpp.
...
Changes to condominium.cpp
----------------------
condominium.cpp is the entry point into condominium-qt, and as such, will require some minor modifications to provide hooks for
